...
class SolarSystem:
    ...
    def gen_planets(self):
        ...
        planets = {
            ...
            # "Urano": AstroBody((pos_sol + 2870990000/K, 100), 5, (8.681/K) * (10**25), (0, 0, 100), force_func=self.force_func(self.G)),
            # "Netuno": AstroBody((pos_sol + 4504000000/K, 100), 5, (1.024/K) * (10**26), (0, 0, 255), force_func=self.force_func(self.G)),
        }
